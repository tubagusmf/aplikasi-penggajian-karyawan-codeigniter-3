...
<div class="container-fluid">
    ...
    <div class="card shadow mx-auto" style="width: 60%;">
        <div class="card-header py-3 bg-primary">
            <h6 class="m-0 font-weight-bold text-white text-center">Filter Laporan Absensi</h6>
        </div>

        <form action="<?= base_url('admin/LaporanAbsensi/cetak_laporan_absensi'); ?>" method="GET">
            <div class="card-body">
